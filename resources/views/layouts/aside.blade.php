    ...
    <div class="hover-scroll-overlay-y mb-5 mb-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
        ...
        <div class="menu menu-column mt-2 menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
            ...
            @if ($role === 'admin')
                ...
                <div class="menu-item">
                    <a class="menu-link {{ isset($path[1]) && $path[1] === 'kategori' ? 'active' : '' }}"
                        ...
                        <span class="menu-icon">
                            ...
                            <span class="svg-icon svg-icon-2">
                                <img src="{{ isset($path[1]) && $path[1] === 'kategori' ? url('assets/media/icons/aside/kategoriact.svg') : url('assets/media/icons/aside/kategoridef.svg') }}"
                                    alt="">
                            </span>
                            <!--end::Svg Icon-->
                        </span>
                        <span class="menu-title"
                            style="{{ isset($path[1]) && $path[1] === 'kategori' ? 'color: #F4BE2A' : 'color: #FFFFFF' }}">Kategori</span>
                    </a>
                </div>
                <!--end::Menu item-->
                ...
                <!--begin::Menu item-->
                <div class="menu-item">
                    <a class="menu-link {{ isset($path[1]) && $path[1] === 'product' ? 'active' : '' }}"
                        href="{{ route('admin.product') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            <span class="svg-icon svg-icon-2">
                                <img src="{{ isset($path[1]) && $path[1] === 'product' ? url('assets/media/icons/aside/pembelianact.svg') : url('assets/media/icons/aside/pembeliandef.svg') }}"
                                    alt="">
                            </span>
                            <!--end::Svg Icon-->
                        </span>
                        <span class="menu-title"
                            style="{{ isset($path[1]) && $path[1] === 'product' ? 'color: #F4BE2A' : 'color: #FFFFFF' }}">Product</span>
                    </a>
                </div>
                <!--end::Menu item-->
            @endif
